...
plt.savefig('train_test3.png')
fig1.savefig(graph_file1)
plt.show()

# summarize history for loss
graph_file2 = 'train_test2.png'
fig2 = plt.figure()
...
plt.savefig('train_test4.png')
fig2.savefig(graph_file2)
plt.show()
...
ax = sns.heatmap(cm_normalised, annot=True, linewidths=0, square=False,
                 cmap="Greens", yticklabels=emotion_labels, xticklabels=emotion_labels, vmin=0,
